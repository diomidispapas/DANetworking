...
// MatrixSDK
#define COCOAPODS_POD_AVAILABLE_MatrixSDK
#define COCOAPODS_VERSION_MAJOR_MatrixSDK 0
#define COCOAPODS_VERSION_MINOR_MatrixSDK 4
#define COCOAPODS_VERSION_PATCH_MatrixSDK 0
